...
\begin{thm}
Let $\kappa$, $\lambda^{\dagger}$ be regular cardinals such that $\omega_1 < \kappa < \lambda^{\dagger}$ and $\kappa$ is measurable. Given that Assumption \ref{thm744} holds, there is a forcing notion of size $2^{< \lambda}$ witnessing $GNb_1'(\kappa, \lambda^{\dagger})$.
\end{thm}
