...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item Fix bijections $\mathrm{Pr1}$ and $\mathrm{Pr2}$ from $\omega \times \omega$ into $\omega$ and from $\omega \times 2^{\omega}$ into $2^{\omega}$ respectively, such that their projection functions are all computable. Given any $(m, n) \in \omega \times \omega$, we use $\langle m, n \rangle$ to denote $\mathrm{Pr1}(m, n)$. Given any $(m, x) \in \omega \times 2^{\omega}$, we use $\langle m, x \rangle$ to denote $\mathrm{Pr2}(m, x)$.
...
\begin{enumerate}[label=(\alph*)]
    \item $e, n < \omega$,
    \item $\Phi^{\emptyset}_e = r$ is a nicely computable code of $H(\omega)$,
...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item $\pi$ is an injection from $f_r" (2^{\omega})$ into $\omega$,
    \item $\Phi^{\emptyset}_{e'} = \{\langle m, n \rangle : (m, n) \in \pi\}$, and
