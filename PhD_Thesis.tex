...
What is left for us to prove is that $\mathbb{P}^C_{\lambda^{\dagger}}(\omega_1)$ adds no $\omega$-sequences of ordinals. Towards this end, let 
\begin{itemize}
...
At this point, there should be an inkling that $p^*$ being a condition of $\mathbb{P}^C_{\lambda^{\dagger}}(\omega_1)$ is difficult to show. In fact, we seem unable to guarantee its consistency with the fulfilment of just one of the 8 modified specifications among \ref{c1} to \ref{c8}. The reader should be able to convince themselves without too much hassle that $p^*$ is extendable to some $\Sigma$ satisfying 
\begin{itemize}
