...
Our line of reasoning --- as intuitive as it is --- juxtaposed with the tiny gap we encountered along the way, point to the probable need for new technology in order to prove Assumption \ref{thm744}. That is, if it were even provable.
