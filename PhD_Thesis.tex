...
Asper\'{o} and Schindler are likely the first to present, in their seminal work \cite{schindler}, not just a construction with plain language fragments as forcing conditions, but also a construction allowing for such fine control of the said fragments that they are able to build a complicated Henkin term model from the generic theory. Here, unlike in previous works, 
\begin{itemize}
