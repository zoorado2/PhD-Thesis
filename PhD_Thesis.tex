...
This section provides a cursory investigation into natural analogues of the constructions that transpired in the proofs of Theorems \ref{notion1} and \ref{notion2}. The said investigation is carried out roughly along three paths.

\subsection{Towards a Two-cofinality Generalisation}\label{2cof}

Let us first recapitulate a part of Subsection \ref{intuit}, namely the high-level description of the forcing construction integral to the proof of Theorem \ref{notion1}. For the rest of this subsection, we adopt the notation of Subsection \ref{intuit}, so that the major components of the proof of Theorem \ref{notion1} are labelled 
\begin{equation*}
...
\end{equation*}
accordingly, from the perspective of the universe $W$ as defined in the proof of Theorem \ref{notion1}. We shall also work in $W$ for the rest of this subsection. 
...
In the spirit of Jensen's results on the Namba extension problem, we are interested in the possibility of modifying the forcing notion $\mathbb{P} = \mathbb{P}_{\lambda^{\dagger}}$ constructed in the proof of Theorem \ref{notion1} in sitable ways so that it does not add reals, under the right assumptions. More generally, we can ask the same about the parametrised versions of said forcing notion. 
