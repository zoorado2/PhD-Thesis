...
Let us now turn our attention to the relation $\leq^M$ and the local method hierarchy. For each of the remaining questions, one can also ask a variant thereof in which we swop out every (explicit or otherwise) instance of the relation $\leq^M$ for an instance of the relation $\leq^N$.
