...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item\label{9252} $\phi$ defines a function from the class of all TCIs into the universe,
    \item\label{9253} $\psi$ defines a function from the class
    \begin{equation*}
...
\begin{itemize}
    ...
    \item Lemma \ref{setcode} can always be utilised to define $\phi$, and thus $\psi$ and $\psi'$, in our modified version of Proposition \ref{prop322}.
\end{itemize}
