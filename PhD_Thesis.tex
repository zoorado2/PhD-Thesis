...
\end{itemize} 
As such, one might wonder if it is possible to generate small extensions of $V$ based locally on a set in $V$, in a way that differs substantively from set forcing. It turns out that there is a relatively simple argument against this.
