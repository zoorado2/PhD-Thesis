...
\end{align*}
would all subsequent lemmas in the proof still go through? What notable forcing-theoretic properties can we use to differentiate among the $\mathbb{P}_{\lambda^{\dagger}}(\theta)$'s that result from varying $\theta$? 
...
\begin{enumerate}[label=(S\arabic*)$_{\lambda}$, leftmargin=40pt]
    \setcounter{enumi}{8}
    \item $\ulcorner \forall A \in [\mathcal{L}^o]^{< \omega_1} \cap Q_{\lambda} \ (E(\ulcorner A \subset \dot{G} \urcorner) \iff \forall x \in A \ (E(x))) \urcorner$,
\end{enumerate}
and re-declare
...
Let $W$ and $\lambda^{\dagger}$ be as in the proof of Theorem \ref{notion1}. In $W$, can $\theta$, $C$, $\mathbb{P}^*$
\begin{gather*}
...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item $\mathbb{P}_{\lambda^{\dagger}}(\theta) \lessdot \mathbb{P}^*$,
    \item \ref{4101} and \ref{4102} of Lemma \ref{lem26} are fulfilled with $\mathbb{P}^*$ in place of $\mathbb{P}$, and
    \item $\mathbb{P}^*$ does not collapse $\omega_1^W$?
\end{enumerate}
\end{ques}
...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item $[Q_{\lambda}]^{< \theta} \subset Q_{\lambda}$ for all $\lambda \in C$,
    \item  \ref{4101} and \ref{4102} of Lemma \ref{lem26} are fulfilled with $\mathbb{P}_{\lambda^{\dagger}}(\theta)$ in place of $\mathbb{P}$, and
    \item $\mathbb{P}_{\lambda^{\dagger}}(\theta)$ does not add reals?
\end{enumerate}
\end{ques}
...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item $[Q_{\lambda}]^{< \theta} \subset Q_{\lambda}$ for all $\lambda \in C$,
    \item $\mathbb{P}'_{\lambda^{\dagger}}(\theta) \lessdot \mathbb{P}^*$,
    \item \ref{K1} to \ref{K5} of Fact \ref{fact436} are fulfilled with $\mathbb{P}^*$ in place of $\mathbb{P}$, and
    \item $\mathbb{P}^*$ does not collapse $\omega_1^W$?
\end{enumerate}
\end{ques}
...
\begin{enumerate}[label=(\arabic*)]
    \item $\theta$ is an infinite cardinal,
    \item $[Q_{\lambda}]^{< \theta} \subset Q_{\lambda}$ for all $\lambda \in C$,
    \item \ref{K1} to \ref{K5} of Fact \ref{fact436} are fulfilled with $\mathbb{P}'_{\lambda^{\dagger}}(\theta)$ in place of $\mathbb{P}$, and
    \item $\mathbb{P}'_{\lambda^{\dagger}}(\theta)$ does not add reals?
\end{enumerate}
\end{ques}
