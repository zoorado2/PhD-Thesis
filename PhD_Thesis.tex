...
\begin{split}
    & \textit{What if we take the overarching tenet of ``definable set} \\ 
    & \textit{generation as computation'' to its logical extreme?}
\end{split}
\end{align}
As the reader will soon discover, (\ref{motqn}) is the motivating question of this thesis.

It is important to note that (\ref{motqn}) is neither a frivolous question nor a purely philosophical musing.
