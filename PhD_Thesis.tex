...
It is perhaps of special note that the particular manner in which \hyperref[7411c4]{Case 4} gets resolved in the proof of the preceding claim hinges on $\mathbb{P}_{\lambda'}$ having finite subsets of $\mathcal{L}$ as conditions. 
\end{rem}
