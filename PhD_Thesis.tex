...
\end{itemize}
in Proposition \ref{prop322}, we should still expect the said proposition to hold. This is because morally, 
\begin{itemize}
...
Let $X \subset \mathbf{M}_S(V)$ be defined by a means fulfilling the requirements suggested by Proposition \ref{prop322} (see Remark \ref{rem926}). Then there is a forcing notion $\mathbb{P} \in V$ such that $\mathrm{Eval}^V(\mathfrak{T}(\mathbb{P})) \subset X$. 
\end{thm}
