...
Note that the $\leq^N$-variant of Question \ref{q843} has a negative answer. Indeed, $X \leq^N \mathsf{Fg}$ for every local method definition $X$ because of Lemma \ref{conalt}.
\end{rem}
